...
export class InitialSchema1757045321821 implements MigrationInterface {
    name = 'InitialSchema1757045321821'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(150) NOT NULL, "email" character varying(100) NOT NULL, "phone" character varying(15) NOT NULL, "address" character varying(500) NOT NULL, "password" text NOT NULL, "type" integer NOT NULL, "status" boolean NOT NULL DEFAULT true, "verified" boolean NOT NULL DEFAULT false, "registration_date" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
